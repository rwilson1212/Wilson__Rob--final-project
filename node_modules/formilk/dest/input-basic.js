...
function inputBasic({ type, ...props }) {
  ...
  useRender(() => jsx('input', { type: type, ...props, slot: "input", ref: refInput,} ));
  ...
  return (
    jsx('host', {
      ...
      , jsx('style', null, inputStyle)
      , jsx('div', { class: "row", onclick: () => refInput.current.focus(),}
        , jsx('div', { class: `icon ${slotIcon.length ? "" : "hidden"}`,}
          , jsx('slot', { ref: refIcon, name: "icon",})
        )
        , jsx('div', {
          class: `label ${
...
const InputBasic = c(inputBasic);

export { InputBasic, inputProps, inputStyle };
//# sourceMappingURL=input-basic.js.map